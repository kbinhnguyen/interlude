...
A: You're absolutely right. I didn't have to. But I wanted to use this MVP project as an opportunity to learn some technologies and implement concepts that are new to me but important to backend development as that is where I have the strongest interest. As a web developer I think it is extremely important to keep SEO in mind as many businesses form marketing strategies around it. Consequently our decisions on tech stack and specific implementations would have a tremendous impact on our clients' revenue.
